...
class BaseObj( object ):
	def __repr__( self ):
		return self.__class__.__name__ + str(self._	)
...
if __name__ == "__main__":
	...
	buf = xenc( [ 1, True,None, [1, 987847 ]*2500 ] )
	print len( buf )
# 1.67 36
	...
	import timeit
	t = timeit.Timer(stmt=" xenc( [ 1, True,None, [1, 987847 ]*250 ] ) ", setup="from __main__ import xenc, buf")
