========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Skin
========================================================================


Diese Skin-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Skin.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Skin.rc eingebunden.
...
SkinDlg.h, SkinDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CSkinDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Skin.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Skin.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
