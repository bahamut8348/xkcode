										 ...
										 UINT uidLastCmd, UINT uFlags )
{
	...
	FolderMenu.InsertMenu(0, MF_BYPOSITION|MF_STRING, uidFirstCmd + MenuCount , L"设置(&S)");
	MenuCount++;
	...
	InsertMenu ( hmenu, 0, MF_BYPOSITION | MF_POPUP, (UINT_PTR)(HMENU)FolderMenu, _T("转到文件夹(&M)") );
...
//	AtlMessageBox(hwnd,(LPCTSTR) temp, L"成功",64);
